...
pub fn fuse_submaps(
    ...
    // 3. Fusion walk: determine visibility between vertices of C1 and C2
    // Shoot horizontal rays from vertices of C1 towards C2, and from C2 towards C1
